...
export default function LoginPage() {
    ...
    const { signupWithEmail, loading, loginWithGoogle } = useAuthStore()
    ...
    const handleGoogleSiginUp = async () => {
    ...
    return (
        <div className="min-h-screen flex  justify-center bg-linear-to-br from-blue-50 via-white to-blue-50 relative overflow-hidden">
            {/* Decorative elements */}
                ...
                <div className='flex items-center'>
                    ...
                    <Card className="w-[90%] max-w-[600px] mx-auto border-gray-200 bg-white shadow-2xl">
                        ...
                        <CardContent className="space-y-5">
                            <form className='flex flex-col gap-4' ref={formRef} action="">
                                <div className="space-y-2">
                                    <Label htmlFor="username" className="text-gray-700 font-medium">Username</Label>
                                    <div className="relative group">
                                        <User className="absolute left-3 top-3 h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
                                        <Input
                                            id="username"
                                            type="text"
                        ...
                        <CardFooter className="flex flex-col space-y-4">
                            ...
                            <div className="flex gap-3">
                                <Button onClick={handleGoogleSiginUp} variant="outline" className="bg-white border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-blue-600 h-11 transition-all px-8 gap-1">
                                    {
                                        loading && googleSignin ?
                                            <>
                                                <span className="flex items-center justify-center">
